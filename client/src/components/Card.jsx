...
export default function Card({ item, subject, onClick, onDelete, delay = 0 }) {
  ...
  return (
    <div
      className="glass-card p-4 sm:p-5 hover:bg-white/[0.07] hover:border-white/20 transition-all duration-300 cursor-pointer active:scale-[0.98] animate-fade-in group relative"
    ...
    >
      ...
      {onDelete && (
        <button
          ...
          className="absolute top-3 right-3 z-10 p-1.5 rounded-lg bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300 transition-all opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
          title="Delete"
        >
